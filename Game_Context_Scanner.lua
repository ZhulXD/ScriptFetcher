...
task.spawn(function()
    ...
    for _, service in ipairs(deep_scan_services) do
        if service then
            ...
            -- OPTIMIZATION: Use recursive scan instead of GetDescendants
            -- This allows us to prune branches that are in the IGNORE_NAMES list,
            -- avoiding O(N) allocation and unnecessary traversal of ignored trees.
